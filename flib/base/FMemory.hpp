#ifndef __FMEMORY_HPP__
#define __FMEMORY_HPP__
#pragma once
...
namespace _mem_internal
{
    ...
    */
    ...
    /* ---------------------------------------- FAllocStamp */
    inline void FAllocStamp(void *p, const FMemStamp &stamp, char const *typeName)
    {
    ...
    inline void *FCalloc(size_t nmemb, size_t size, const char* file = NULL, const char* func = NULL, int line = 0)
    {
    #ifdef _F_USE_MEMTRACK
...
#define FLIB_REALLOC(p, size) FStd::FMemory::Realloc(p, size, __FILE__, __FUNCTION__, __LINE__)
#define FLIB_FREE(p) FStd::FMemory::Free(p)
#define FLIB_ZALLOC(type) (type*)FStd::FMemory::Calloc(1, sizeof(type), __FILE__, __FUNCTION__, __LINE__)
#define FLIB_ZALLOCN(type, n) (type*)FStd::FMemory::Calloc(n, sizeof(type), __FILE__, __FUNCTION__, __LINE__)
#define FLIB_ZREALLOC(type, p, n) (type*)FStd::FMemory::Realloc(p, (n) * sizeof(type), __FILE__, __FUNCTION__, __LINE__)

#endif//__FMEMORY_HPP__